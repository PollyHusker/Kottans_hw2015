...
namespace Matrix.Tests
{
    public class MatrixTests
    {
        ...
        [Test]
        public void ToString_Always_PrintsOutUnderlyingMatrix2()
        {
            CoolMatrix matrix = new[,]
            {
                { 1, 2 }
        ...
        [Test]
        public void Indexer_WhenUsed_ReturnsDataFromMatrix2()
        {
            CoolMatrix matrix = new[,]
            {
                { 1, 2 }
        ...
        [Test]
        public void AdditionOperator_AmongMatricies_AddsCorrespondingEntries2()
        {
            CoolMatrix matrixA = new[,]
            {
                { 3, 4 }
